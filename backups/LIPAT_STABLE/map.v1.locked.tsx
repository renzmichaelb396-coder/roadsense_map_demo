...
import { loadHazards, addHazard, deleteHazardById, Hazard } from "@/lib/hazards";
...
export default function MapScreen() {
  ...
  useEffect(() => {
    (async () => {
      const stored = await loadHazards();
      setHazards(stored);
    })();
  ...
  return (
    <View style={styles.container}>
      <MapView onLongPress={enterPlacingMode}
        style={styles.map}
